...
#filtra as mesmas vendas usando %in%, uma forma mais compacta para múltiplas comparações 
#da mesma variável 
dados_vendas_limpos |> 
...
#seleciona apenas as colunas da cidade, produto e receita
dados_vendas_limpos |>
...
#cria a variável receita total, agrupa por cidade,calcula a receita total por 
#cidade e ordena o resultado 
dados_vendas_limpos |> 
  mutate(receita_total = unidades * preco_unitario) |> 
  group_by(cidade) |> 
